      ...
      <main className="flex-grow pt-28 pb-20 space-y-20 sm:space-y-28">
        ...
        <section className="px-6 sm:px-12 max-w-[1920px] mx-auto">
          <div className="space-y-5 max-w-3xl">
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-light tracking-tight leading-tight text-white">
              ...
              <span className="text-slate-300">frontline of autonomy.</span>
            </h1>
        ...
        <section className="px-6 sm:px-12 max-w-[1920px] mx-auto">
          <div className="relative isolate rounded-[32px] sm:rounded-[40px] overflow-hidden min-h-[420px] flex flex-col justify-end border border-white/10 shadow-2xl group cursor-pointer">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#020e1c] via-[#020e1c]/60 to-transparent" />
            <div className="relative z-10 p-8 sm:p-14 space-y-4 max-w-3xl">
              <span className="text-[11px] font-mono bg-blue-500/20 text-blue-300 border border-blue-500/30 px-3 py-1 rounded-full uppercase tracking-wider">
        ...
        <section className="px-6 sm:px-12 max-w-[1920px] mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {BLOG_POSTS.slice(1).map((post) => (
              <div
                key={post.id}
                className="rounded-[28px] bg-[#05111f] border border-white/10 overflow-hidden hover:border-white/20 transition-all duration-300 group cursor-pointer flex flex-col"
              >
                <div className="relative h-[180px] overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#05111f] to-transparent" />
                </div>
                <div className="p-6 space-y-3 flex flex-col flex-grow">
                  <div className="flex items-center space-x-2">
                    <span className="text-[10px] font-mono bg-blue-500/15 text-blue-300 border border-blue-500/25 px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                      {post.category}
                    </span>
                    <span className="text-[10px] text-slate-500">{post.readTime}</span>
                  </div>
                  <h3 className="text-sm sm:text-base font-medium text-white leading-snug group-hover:text-blue-200 transition-colors">
                    {post.title}
                  </h3>
        ...
        <section className="px-6 sm:px-12 max-w-[1920px] mx-auto">
          <div className="rounded-[32px] bg-gradient-to-r from-[#031326] to-[#08203d] border border-white/15 p-8 sm:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-3 max-w-xl">
              <h3 className="text-2xl sm:text-3xl font-light text-white">Stay ahead of the mission.</h3>
