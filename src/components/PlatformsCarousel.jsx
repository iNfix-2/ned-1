...
export default function PlatformsCarousel({ onOpenContact, onOpenGallery, onSelectPlatform }) {
  ...
  return (
    <section
      id="platforms"
      className="relative w-full pt-12 sm:pt-16 pb-12 sm:pb-16 px-4 sm:px-8 lg:px-12 flex flex-col items-center bg-[#020e1c] text-center overflow-hidden"
    ...
    >
      <div className="max-w-6xl w-full mx-auto relative z-10 space-y-6 sm:space-y-8 flex flex-col items-center justify-center">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3 px-4">
          ...
          <p className="text-xs sm:text-sm md:text-base text-slate-200/90 max-w-2xl mx-auto leading-relaxed drop-shadow">
