...
import { Play, X, GraduationCap, Award, Compass, BookOpen } from 'lucide-react';

const ACADEMY_DATA = [
  {
    id: 'pilot-certification',
    title: 'Tactical UAS Pilot Certification',
    description: 'Accredited professional pilot training covering flight dynamics, BVLOS navigation, complex airspace management, emergency maneuvers, and civil/defense UAV licensing.',
    backdrop: '/assets/images/academy/nati-piloting-field.jpg',
    thumb: '/assets/images/academy/nati-piloting-field.jpg',
    orbitLabel: 'UAS Pilot Licensing',
    specs: ['BVLOS Flight Doctrine', 'Live Range Operations', 'Civil & Military Licensing', 'Emergency Protocols'],
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-drone-flying-over-clouds-40455-large.mp4'
  },
  {
    id: 'avionics-engineering',
    title: 'Avionics & Systems Engineering',
    description: 'Hands-on engineering curriculum in drone architecture, telemetry integration, embedded firmware calibration, sensor gimbal synchronization, and powertrain optimization.',
    backdrop: '/assets/images/academy/nati-engineering-workshop.jpg',
    thumb: '/assets/images/academy/nati-engineering-workshop.jpg',
    orbitLabel: 'Avionics Engineering',
    specs: ['Hardware Architecture', 'Firmware & Telemetry', 'Sensor Fusion Labs', 'Maintenance & Overhaul'],
  ...
  },
  {
    ...
    description: 'Specialized intelligence training for drone operators in edge computer vision, automated target detection, orthomosaic mapping, multispectral analysis, and tactical reconnaissance.',
    backdrop: '/assets/images/academy/nati-classroom-training.jpg',
    thumb: '/assets/images/academy/nati-classroom-training.jpg',
    orbitLabel: 'AI & Geospatial Analytics',
    specs: ['Edge Computer Vision', 'Orthomosaic 3D Mapping', 'Thermal & Multispectral', 'Mission Intelligence C2'],
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-top-view-of-a-rural-forest-road-42686-large.mp4'
  },
  {
    id: 'defense-tactics',
    title: 'Defense & Security Flight Operations',
    description: 'Specialized tactical operational doctrine for government agencies and defense forces, including counter-UAS response, convoy escort aerial support, and perimeter surveillance.',
    backdrop: '/assets/images/academy/nati-flight-simulation.jpg',
    thumb: '/assets/images/academy/nati-flight-simulation.jpg',
    orbitLabel: 'Defense & Tactical Doctrine',
    specs: ['Counter-UAS Doctrine', 'Perimeter & Border Patrol', 'Secure Comms Protocols', 'Multi-Agent Coordination'],
...
export default function AcademyPage(props) {
  ...
  const activeItem = ACADEMY_DATA[activeIdx];

  useEffect(() => {
    if (videoModalOpen) return;
    const id = setInterval(() => {
      setActiveIdx((prev) => (prev + 1) % ACADEMY_DATA.length);
    }, 6000);
